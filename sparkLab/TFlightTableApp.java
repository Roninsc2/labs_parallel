...
public class TFlightTableApp {
    ...
    public static void main(String[] args) {
        ...
        JavaPairRDD<Tuple2<Integer, Integer>, TFlightDataCalc> dataCalc = flightClmn.mapToPair(val -> new Tuple2<>(new Tuple2<>(getId(val, ORIGIN_ID_CLMN), getId(val, DEST_ID_CLMN)),
